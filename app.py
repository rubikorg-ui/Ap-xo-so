...
# --- HÀM 1: CẬP NHẬT LOGIC SORT (HỖ TRỢ SORT BY VOTE) ---
...
def main():
    ...
    with st.sidebar:
        ...
        if STRATEGY_MODE == "🛡️ V24 8x Vote":
            st.warning("ℹ️ MODE 8X VOTE: Phân nhóm V24 -> Lấy nguồn 8X -> Sort theo Vote -> Liên Minh & Giao Thoa.")
